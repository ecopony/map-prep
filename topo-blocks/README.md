...
- **Multiple Color Schemes**: 8 built-in color schemes (sunset, ocean, forest, earth, neon, monochrome, warm, cool)
...
designer.create_block_design("Mt Adams", "output/mt_adams_sunset.png", 
...
- **sunset**: Warm reds and pinks
- **ocean**: Deep blues  
- **forest**: Greens
- **earth**: Browns and tans
- **neon**: Bright contrasting colors
